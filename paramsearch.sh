...
# Run Experiments
python3 run.py --batch_size=64 --log_dir=$log_dir >> $log_dir/results.txt
# python3 run.py --batch_size=128 --log_dir=$log_dir >> $log_dir/results.txt
# python3 run.py --batch_size=256 --log_dir=$log_dir >> $log_dir/results.txt
